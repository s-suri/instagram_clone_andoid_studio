    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, GroupRequestFragment.RequestViewHolder> adapter
                                                                    ...
                                                                    if (task.isSuccessful()){
                                                                        ...
                                                                        chatRequestRef.child(list_user_id).child(currentUserId)
                                                                            ...
                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                ...
                                                                                if (task.isSuccessful())
                                                                                {
                                                                                    Toast.makeText(getApplicationContext(), "Contact Delete", Toast.LENGTH_SHORT).show();
                                                                                }
                                                                            }
                                                                        });
                                                                    }
            ...
            public GroupRequestFragment.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                GroupRequestFragment.RequestViewHolder viewHolder = new GroupRequestFragment.RequestViewHolder(view);
