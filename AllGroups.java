...
public class AllGroups extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UsersRef = FirebaseDatabase.getInstance().getReference().child("Group");
    ...
    private void firebaseSearch(String newText) {
        ...
        Query ChatsRef = UsersRef.orderByChild("groupName").startAt(query).endAt(query + "\uf8ff");
                    ...
                    protected void onBindViewHolder(@NonNull FindFriendActivity.FindFriendViewHolder holder, final int position, @NonNull Contacts model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent profileIntent = new Intent(AllGroups.this,GroupProfileActivity.class);
