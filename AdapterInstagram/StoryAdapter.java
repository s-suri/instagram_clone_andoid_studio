...
import com.some.studychats.AddStoryActivityInstagram;
...
import com.some.studychats.StoryActivityInstagram;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if (i == 0) {
            View view = inflater.inflate(R.layout.add_story_item_instagram, viewGroup, false);
            return new ViewHolder(view);
        } else {
            View view = inflater.inflate(R.layout.story_item_instagram, viewGroup, false);
            return new ViewHolder(view);
        }
    }
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (viewHolder.getAdapterPosition() == 0){
                    ...
                    // TODO: go to story
                    Intent intent = new Intent(mContext, StoryActivityInstagram.class);
                ...
                if (click) {
                    if (count > 0) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Add Story",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent(mContext, AddStoryActivityInstagram.class);
                                        mContext.startActivity(intent);
                                        dialog.dismiss();
                                    }
                                });
