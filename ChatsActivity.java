...
public class ChatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFriendAdapter = new ChatsAdapter(ChatsActivity.this, commentList);
        ...
        fab_status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChatsActivity.this, GroupActivity.class);
    ...
    */
    ...
    private  void startMainActivity(){
        Intent mainIntent = new Intent(ChatsActivity.this, MainActivity.class);
